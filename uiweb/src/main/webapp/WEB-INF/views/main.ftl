...
<html>
	...
	<body>
		...
		<div class="container-fuil">
			<div id="carousel-banner-generi" class="carousel slide el-banner" data-ride="carousel" data-interval="2000">
			...
			<div class="panel el-panel">
				<div class="panel-title">
					...
					<div class="pull-right">
						<a class="btn btn-link " href="/invest_list.do">
							进入投资列表
						</a>
					</div>
				</div>
					...
					<ul>
						<li>
							<a href="#">
								...
								<span class="pull-right">发表日期：2018-12-30</span>
