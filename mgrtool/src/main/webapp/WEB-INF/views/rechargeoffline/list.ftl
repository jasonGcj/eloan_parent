			...
			<div class="col-sm-9">
				...
				<form id="searchForm" class="form-inline" method="post" action="/rechargeOffline.do">
					...
					<div class="form-group">
					    ...
					    <script type="text/javascript">
					    	$("[name=bankInfoId] option[value='${(q.bankInfoId)!''}']").attr("selected","selected");
					    </script>
					</div>
					<div class="form-group">
					    <label>交易时间</label>
					    <input class="form-control" type="text" name="beginDate" id="beginDate" value="${(q.beginDate?string('yyyy-MM-dd'))!''}" />到
					    <input class="form-control" type="text" name="endDate" id="endDate" value="${(q.endDate?string('yyyy-MM-dd'))!''}" />
					</div>
					<div class="form-group">
					    <label>交易号</label>
					    <input class="form-control" type="text" name="tradeCode" value="${(q.tradeCode)!''}" />
					</div>
					<div class="form-group">
