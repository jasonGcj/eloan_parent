			...
			<div role="tabpanel">
			  ...
			  <div class="tab-content">
			    			...
			    			<div class="form-group">
			    				...
			    				<div class="col-sm-10">
			    					<select class="form-control" style="width: 480px;" name="bankInfo.id">
			    						<#list banks as bank>
				    						<option value="${bank.id}">${bank.accountNumber}${bank.forkName}
											</option>
				    					</#list>
			    					</select>
			    				</div>
			    ...
			    <div role="tabpanel" class="tab-pane " id="tab1">
			    	...
			    	<form id="rechargeOnlineForm" class="form-horizontal el-recharge-form" action="/recharge/pay.do" method="post">
                        <div class="form-group">
                            <label class="control-label col-lg-2">当前可用余额</label>
                            <div class="col-sm-3">
                                <input class="form-control" name="currentAmount" readonly value="${account.usableAmount}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2">充值金额</label>
                            <div class="col-sm-3">
                                <input class="form-control" name="amount" />
                                <input type="hidden" name="minAmount" value="${minRechargeAmount}" />
                            </div>
                        </div>
