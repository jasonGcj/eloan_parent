...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
			...
			form.find("[name=fileType]").html(json.fileType);
			form.find("[name=file]").attr("src",json.file);
			
			//清空审核表单
			form.find("[name=score] option:eq(0)").prop("selected",true);
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/userFileAuth_audit.do">
					<fieldset>
						<div id="legend" class="">
						...
						<div class="row">
				        	<label class="col-sm-4 control-label" for="name">资料类型</label>
				        	<div class="col-sm-8">
						...
						<div class="row">
				        	<label class="col-sm-4 control-label" for="name">资料图片</label>
				        	<div class="col-sm-8">
				        		<img src="" name="file" style="width: 150px;"/>
				        	</div>
						</div>
						<div class="row">
				        	<label class="col-sm-4 control-label" for="name">征信分数</label>
				        	<div class="col-sm-8">
			        			<select class="form-control" name="score" style="width: 180px" autocomplate="off">
									  <#list 0..10 as data>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="name">审核备注</label>
				        	<div class="col-sm-9">
