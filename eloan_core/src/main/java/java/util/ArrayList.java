 ...
 * ORACLA PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 *
 *
 *
 *
...
public class ArrayList<A> extends AbstractList<A>
        implements List<A>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
    public ArrayList(Collection<? extends A> c) {
    ...
    public Object clone() {
        try {
            @SuppressWarnings("unchecked")
                ArrayList<A> v = (ArrayList<A>) super.clone();
    ...
    private class SubList extends AbstractList<A> implements RandomAccess {
        private final AbstractList<A> parent;
        private final int parentOffset;
        private final int offset;
        int size;

        SubList(AbstractList<A> parent,
        ...
        public A set(int index, A e) {
            rangeCheck(index);
            checkForComodification();
            A oldValue = ArrayList.this.elementData(offset + index);
